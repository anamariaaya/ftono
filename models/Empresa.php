...
class Empresa extends ActiveRecord{
    ...
    protected static $columnasDB = ['id', 'empresa', 'id_fiscal', 'direccion', 'ciudad', 'pais', 'instagram', 'nombre_comercial', 'apellido_comercial', 'email_comercial', 'tel_comercial', 'nombre_contable', 'apellido_contable', 'email_contable', 'tel_contable', 'id_usuario'];
